        ...
        listener: (context, state) {
          if (state is SignUpSuccess && state.provider == 'LinkedIn') {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => LinkedInScreen()));
          }
        },
        child: Scaffold(
          body: SafeArea(
              ...
              child: Column(children: [
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        Batch16String.current.createAccount,
                        style: TextStyle(
                      ...
                      listener: (context, state) {
                        if (state is SignUpFailed &&
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              content: Text(Batch16String.current
                                  .notSupported('Github'))));
                        }
                      },
                      child: AccountHolder(
                ...
                BlocBuilder<SignUpCubit, SignUpState>(
                  ...
                  if (state is SignUpFailed && state.provider == 'google') {
                    return Text(
                        Batch16String.current.notSupported(state.provider));
                  }
                ...
                SizedBox(height: 20),
                Text(
                  Batch16String.current.alreadyHaveAccount,
                  style: TextStyle(fontWeight: FontWeight.w400, fontSize: 13),
                ),
                SizedBox(height: 20),
